...
\author{Aurelie Mawart}
 %\affiliation[Also at ]{Physics Department, XYZ University.}%Lines break automatically or can be forced with \\
...
%\affil[1]{Khalifa Univeristy, Department of Biomedical Engineering}
%\affil[2]{Khalifa Univeristy, Department of Electrical Engineering and Computer Science}


\begin{abstract}
    We here present comprehensive phylogenetic trees of world populations based on HLA allele frequency data. The tree for HLA-A and HLA-B includes 246 populations, while the tree for HLA-A, HLA-B and HLA-  Data availability and tree robustness The tradeoff between inclusion of populations and HLA genes depends on Strong emphasis has been laid on branch support validation with a bootstrapping technique that is suitable for few, even single hyperpolymorphic genes.
    The tree is based on publicly available HLA allele data on AlleleFrequencies.net,.
